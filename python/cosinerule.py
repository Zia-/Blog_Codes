...
for y in cursor1:
AB = math.sqrt(abs((6371000+y[0])**2 + (6371000+y[1])**2 - 2*(6371000+y[0])*(6371000+y[1])*(math.cos(y[2])))) # Cos function is taking radian values
cursor2.execute('update kn_ways_new_split set length_dem = %s where n_id = (%s+1)', [AB, x])
