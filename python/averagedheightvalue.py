...
connection.commit() # This commit code is essential, otherwise the execute update code will not get executed (but I dont know why the first execute code doesnt need any commit code)